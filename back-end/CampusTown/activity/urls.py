...
from activity.views import host2_language, host2_category
from . import views

urlpatterns = [
   # url(r'^activity/$', views.host0, name='hosting'),
   # url(r'^activity/1$', views.host1, name='hosting'),
    url(r'^activity/2/language$', views.host2_language, name='hosting language'),
    url(r'^activity/2/category$', views.host2_category, name='hosting category'),
